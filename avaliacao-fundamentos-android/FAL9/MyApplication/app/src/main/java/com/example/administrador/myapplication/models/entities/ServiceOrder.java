...
public class ServiceOrder implements Parcelable {
    ...
    public boolean equals(Object o) {
        ...
        if (mActive != null ? !mActive.equals(that.mActive) : that.mActive != null) return false;
    ...
    public static List<ServiceOrder> findAll(ServiceOrder serviceOrder) {
        return ServiceOrdersRepository.getInstance().findAll(serviceOrder);
    }
    ...
    private ServiceOrder(Parcel in) {
        ...
        this.mActive = (Integer) in.readValue(Integer.class.getClassLoader());
    }
