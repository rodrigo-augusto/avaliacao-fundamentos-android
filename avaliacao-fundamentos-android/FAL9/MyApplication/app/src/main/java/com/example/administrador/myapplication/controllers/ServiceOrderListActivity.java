...
public class ServiceOrderListActivity extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
    ...
    private boolean isShowActives = true;
    private ServiceOrder mServiceFiltro = new ServiceOrder();
    ...
    private void updateRecyclerItens() {
        mServiceFiltro.setActive(isShowActives ? 1 : 0);
        final List<ServiceOrder> serviceOrders = ServiceOrder.findAll(mServiceFiltro);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.actionShare:
                ...
                return true;
            case R.id.actionShowDeactive:
                isShowActives = !isShowActives;
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        final MenuItem menuActives = menu.findItem(R.id.actionShowDeactive);
        if (isShowActives) {
            menuActives.setTitle(getString(R.string.lbl_item_menu_show_deactive));
        } else {
            menuActives.setTitle(getString(R.string.lbl_item_menu_show_active));
        }
